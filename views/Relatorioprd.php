       ...
       <div class="content-wrapper">
          <div class="content-header">
             <div class="container-fluid">
                 <div class="row mb-2">
                <div class="col-sm-6">
            <h1>Relatorio de Vendas por Produto</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/index.php">Inicio</a></li>
              <li class="breadcrumb-item active">Relatorio de Vendas  por Produto</li>
            </ol>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="produto" class="table table-bordered table-hover">
                <thead>
                  <tr>
                  <th style="text-align:center;width: 60%">Produto</th>
...
listar();
  ...
  $.ajax({
    type: "POST",
    url: "/DTO/call/relatorio/listarProduto.php",
    data: {datain:datain},
    dataType: "html",
    success: function (result) {
      $.ajax({
    type: "POST",
    url: "/DTO/call/relatorio/listarProdutoTotal.php",
    data: {datain:datain},
    dataType: "html",
    success: function (result) {
